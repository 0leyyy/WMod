...
public class BobsEntity extends Monster implements VibrationSystem {
	...
	public BobsEntity(EntityType<BobsEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RemoveBlockGoal(Blocks.SHORT_GRASS, this, 1, (int) 3));
		this.goalSelector.addGoal(3, new LookAtPlayerGoal(this, Player.class, (float) 12));
		this.goalSelector.addGoal(4, new LookAtPlayerGoal(this, BobsEntity.class, (float) 12));
	}
	...
	public void addAdditionalSaveData(CompoundTag compound) {
		...
		VibrationSystem.Data.CODEC.encodeStart(this.registryAccess().createSerializationContext(NbtOps.INSTANCE), this.vibrationData).resultOrPartial(e -> WModMod.LOGGER.error("Failed to encode vibration listener for Bobs: '{}'", e))
	...
	public void readAdditionalSaveData(CompoundTag compound) {
		...
		if (compound.contains("listener", Tag.TAG_COMPOUND)) {
			VibrationSystem.Data.CODEC.parse(this.registryAccess().createSerializationContext(NbtOps.INSTANCE), compound.getCompound("listener")).resultOrPartial(e -> WModMod.LOGGER.error("Failed to parse vibration listener for Bobs: '{}'", e))
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(WModModEntities.BOBS.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	private class VibrationUser implements VibrationSystem.User {
		private final BobsEntity entity = BobsEntity.this;
		...
		public TagKey<GameEvent> getListenableEvents() {
			return TagKey.create(Registries.GAME_EVENT, ResourceLocation.withDefaultNamespace("bobs_can_listen"));
		}
